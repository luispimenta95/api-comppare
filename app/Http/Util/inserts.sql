INSERT INTO `planos` (`id`, `nome`, `descricao`, `valor`, `tempoGratuidade`, 
`quantidadeTags`, `quantidadeFotos`, `quantidadePastas`, `quantidadeSubpastas`,
 `frequenciaCobranca`, `status`, `idHost`, `created_at`, `updated_at`, `quantidadeConvites`)
VALUES

(1, 'Plano Gratuito', 'Plano Gratuito', 0, 360, 3, 5, 4, 5, 0, 1, NULL, NULL, NULL, 0),
(2, 'Plano de Filiados', 'Plano de Filiados', 0, 180, 10, 15, 40, 5, 0, 1, NULL, NULL, NULL, 0),
(3, 'Plano Avançado', 'Plano Avançado', 39.9, 15, 10, 2, 40, 5, 1, 1, 122814, '2025-03-18 14:51:14', '2025-03-18 14:51:14', 0),
(4, 'Plano Avançado Anual', 'Plano Avançado Anual', 383, 15, 10, 2, 40, 5, 12, 1, 122815, '2025-03-18 14:53:11', '2025-03-18 14:53:11', 0),
(5, 'Plano de Convidados', 'Plano de Convidados', 0, 360, 0, 0, 0, 5, 0, 1, NULL, '2025-03-25 19:32:44', '2025-03-25 19:33:00', 0);
